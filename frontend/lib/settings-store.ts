...
export const useSettingsStore = create<SettingsState>()(
  persist(
    ...
    }),
    {
      ...
      // v2 drops detailedAnswerContextMode and ships real defaults for the
      // detailed-answer and chat prompts. Migration is idempotent and only
      // fills empty values; user edits survive.
      version: 2,
      migrate: (persistedState) => {
        ...
        if (
          ...
          (s.suggestionContextChunkCount as number) < 1
        ) {
